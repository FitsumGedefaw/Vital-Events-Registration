...
function validate_name(){
    ...
    let patt=/[0-9]+/;
	if( name.value == "" ){
            error_messages.push("Please provide name!");
            name.focus() ;
            return;
         }
...
function validate_f_name(){
    ...
    let patt=/[0-9]+/;
	if( f_name.value == "" ){
            error_messages.push("Please provide father name!");
            f_name.focus() ;
            return;
         }
...
function validate_g_name(){
    ...
    let patt=/[0-9]+/;
	if( g_name.value == "" ){
            error_messages.push("Please provide grand father name!");
            g_name.focus() ;
            return;
         }
...
function validate_ssn(){
	...
	if( ssn.value == "" ){
            error_messages.push("Please provide ssn!");
            ssn.focus() ;
            return;
         }
...
function validate_birth_date(){
    ...
    if( birth_date.value == "" ){
        error_messages.push("Please provide birth date!");
        birth_date.focus();
        return;
     }
}
...
function validate_birth_place(){
    ...
    if( birth_place.value == "" ){
        error_messages.push("Please provide birth place!");
        birth_place.focus();
        return;
     }
}
...
function validate_death_date(){
    ...
    if( death_date.value == "" ){
        error_messages.push("Please provide death date!");
        birth_date.focus();
        return;
     }
}
...
function validate_sex(){
    ...
    if(!(male.checked || female.checked)){
        error_messages.push("Please select sex!");
    }
}
