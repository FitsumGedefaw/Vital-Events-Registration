...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($image && $image['tmp_name']) {
        ...
        $statement = $pdo->prepare("INSERT INTO marriage_table (m_ssn ,p_ssn, image, name, f_name, g_name, birth_date, birth_place)
                VALUES (:m_ssn,:p_ssn, :image, :name, :f_name, :g_name, :birth_date, :birth_place)");
...
<head>
    ...
    <title>Marriag registration page</title>
    <link rel="stylesheet" href="./style/style.css">
    <script defer src="script/script_add_marriage.js"></script>
</head>
    ...
    <div class="container">
        ...
        <form method="post" id="myForm" enctype="multipart/form-data">
            ...
            <fieldset class="fieldset">
                <legend class="legend">Put yours partner personal info here</legend>
